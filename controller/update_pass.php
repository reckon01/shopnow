...
include_once "../database/connection.php";
  $query="UPDATE customer SET password = '$_POST[newpass]' WHERE mobile='$_POST[mob]'";
...
<p><font face="verdana" color="white" size="5">Congratulations, You have successfully Changed your password.
<a href="../view/client_login.php" style=" color:red"><i>Click Here!</i></a> to login with your New Password. </font></p> 
