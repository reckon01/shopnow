...
<section>
<br><br><br><br><br><br>
<h1 style="color:blue" align="center">SUCCESS!</h1>
<p><font face="verdana" color="white" size="5"><i style="color:cyan">
<?php echo $_SESSION['login']; ?></i>, you have successfully registered to <i style="color:cyan">MyShopping</i><i style="color:blue">Cart</i>. Now you are a prime member of our family. Explore different exciting products and order them without any headache.
<a href="../index.php" style=" color:red"><i>Click Here!</i></a> to go to Home page. </font></p> 
