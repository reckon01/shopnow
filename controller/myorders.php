...
$query="SELECT * FROM orders WHERE account_mobile='$m'";
...
if($num_rows==0)
{
	...
	echo "<p><font face='verdana' color='blue' size='5'><i style='color:black'>".$_SESSION['login']."</i>, You have not ordered any products yet. <a href='../index.php'><i style='color:red'>Click Here</i></a> to start shopping.</font></p>";
