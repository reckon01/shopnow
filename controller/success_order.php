...
<?php echo $_SESSION['login']; ?></i>, you have successfully placed  your order on <i style="color:cyan">MyShopping</i><i style="color:blue">Cart</i>. Please keep patience, your product will be delivered shortly. Have a nice time! <a href="../index.php" style=" color:red"><i>Click Here!</i></a> to continue Your Shopping. </font></p> 
